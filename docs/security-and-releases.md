...
```sh
gh release download v0.1.0 --repo IanHollow/finder-favorites --dir release
cd release
shasum -a 256 -c finder-favorites-v0.1.0.tar.gz.sha256
gh attestation verify finder-favorites-v0.1.0.tar.gz \
  --repo IanHollow/finder-favorites \
  --bundle finder-favorites-v0.1.0.intoto.jsonl \
